...
def test_greedy_mc(solver):
    ...
    seed_list = (1234,)
    iterator = solver(2, error_tolerance=error_tolerance, seed_list=seed_list)
    ...
    iterator = solver(2, max_budget=max_budget, seed_list=seed_list)
...
def test_greedy_mlmc(solver):
    ...
    # Define greedy MC iterator with same budget
    iterator = solver(
        2, cost_per_level=cost_per_level, max_budget=max_budget, seed_list=seed_list
    )
